# Lab 8: Oracle WebLogic Operator Tutorial #
...
### You are now ready to move to the next lab - [Lab 9: Assigning WebLogic Pods to Licensed Nodes](node.selector.license.md) ###
